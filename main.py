    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "awebvideos.classplusapp" in url:
            	headers = {'Host': 'api.classplusapp.com', 'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..RfL_Yb2ONWFnuIwVcmoXSB9zZ49mAOZQBqB6uFDCXzY-2Kzwck8u5HKW3bWguqpQ', 'user-agent': 'Mobile-Android', 'app-version': '1.4.37.1', 'api-version': '18', 'device-id': '5d0d17ac8b3c9f51', 'device-details': '2848b866799971ca_2848b8667a33216c_SDK-30', 'accept-encoding': 'gzip'}
            	params = (('url', f'{url}'),)
           ...
           if "jw-prod" in url:
            ...
            # Ab yahan se aapka try block shuru hona chahiye
            try:
                # ... baki ka code  
